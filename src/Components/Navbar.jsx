...
function Navbar(){
    return(
        ...
        <nav className="navbar navbar-expand-md bg-body-tertiary my-2 align-items-center">
        <div className="container-fluid">
            <Link to="/">
            <img src={logo} alt="logo" width="40px" className=" ms-4 ms-lg-5" />
            </Link>
            ...
            <ul className="navbar-nav me-auto mb-2 mb-lg-0 fs-6">
                <li className="nav-item  mx-3 mx-lg-4 ">
